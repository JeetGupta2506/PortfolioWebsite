            ...
            {experiences.map((exp, index) => (
              <div key={index} className="relative mb-8 sm:mb-12 lg:mb-16">
                <div className={`flex flex-col lg:flex-row lg:items-center ${
                  ...
                  <div className={`bg-white rounded-2xl shadow-lg p-4 sm:p-6 lg:p-8 ml-12 lg:ml-0 animate-slide-in-${index % 2 === 0 ? 'right' : 'left'} will-change-transform ${
                    index % 2 === 0 
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              {certifications.map((cert, index) => (
                ...
                >
                  ...
                  <p className="text-gray-600 text-xs sm:text-sm mb-2">{cert.issuer}</p>
                  <div className="flex items-center justify-center gap-2 mt-1">
                    <span className="inline-block bg-blue-600 text-white px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm hover-button-3d transform-3d">{cert.year}</span>
                  </div>
                </div>
              ))}
            </div>
